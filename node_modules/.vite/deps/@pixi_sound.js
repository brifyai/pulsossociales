...
var _Sound = class {
   ...
   */
  preferUrl(urls) {
    const [{ url }] = urls.map((url2) => ({ url: url2, ext: lib_exports.path.extname(url2).slice(1) })).sort((a, b) => extensions2.indexOf(a.ext) - extensions2.indexOf(b.ext));
    return url;
  }

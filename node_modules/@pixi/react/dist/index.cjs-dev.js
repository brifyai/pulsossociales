...
var constants$1 = require('@pixi/constants');
...
function isPointType(value) {
  return value instanceof math.Point || value instanceof math.ObservablePoint;
}
...
var getTextureFromProps = function getTextureFromProps(elementType, root) {
  ...
  if (props.texture) {
    invariant(props.texture instanceof core.Texture, "".concat(elementType, " texture needs to be typeof `Texture`"));
  ...
  var result = check('image', {
    ...
    instanceofs: [HTMLImageElement, HTMLVideoElement, HTMLCanvasElement, core.Texture]
  });
  invariant(!!result, "".concat(elementType, " could not get texture from props"));
  var texture = core.Texture.from(result);
  texture.__reactpixi = {
    root: root
  };
...
function applyDefaultProps(instance, oldProps, newProps) {
  var changed = false;
  invariant(display.DisplayObject.prototype.isPrototypeOf(instance), 'instance needs to be typeof `DisplayObject`, got `%s`', _typeof(instance));
...
var BitmapText$1 = function BitmapText(root, props) {
  var text = props.text,
    style = props.style;
  return new textBitmap.BitmapText(text, style);
};
...
var Graphics$1 = function Graphics(root, _ref) {
  ...
  invariant(!geometry || geometry instanceof graphics.Graphics, "Graphics geometry needs to be a `PIXI.Graphics`");
  var g = geometry ? new graphics.Graphics(geometry.geometry) : new graphics.Graphics();
...
var NineSlicePlane$1 = function NineSlicePlane(root, props) {
  ...
  var nineSlicePlane = new meshExtras.NineSlicePlane(texture, leftWidth, topHeight, rightWidth, bottomHeight);
...
var ParticleContainer$1 = function ParticleContainer(root, props) {
  ...
  var container = new particleContainer.ParticleContainer(maxSize, properties, batchSize, autoResize);
...
var Sprite$1 = function Sprite(root, props) {
  var sprite$1 = new sprite.Sprite(getTextureFromProps('Sprite', root, props));
  sprite$1.applyProps = function (instance, oldProps, newProps) {
    var image = newProps.image,
      texture = newProps.texture,
...
var AnimatedSprite$1 = function AnimatedSprite(root, props) {
  ...
  var makeTexture = function makeTexture(textures) {
    return textures.map(function (texture) {
      invariant(texture instanceof core.Texture || (texture === null || texture === void 0 ? void 0 : texture.texture), "AnimationSprite texture needs to be an array of `PIXI.Texture` or `{ texture: PIXI.Texture, time:\n                number }`");
      return texture;
    });
  };
  var animatedSprite = images ? spriteAnimated.AnimatedSprite.fromImages(images) : new spriteAnimated.AnimatedSprite(makeTexture(textures));
...
var Text$1 = function Text(root, props) {
  var _props$text = props.text,
    text$1 = _props$text === void 0 ? '' : _props$text,
    _props$style = props.style,
    style = _props$style === void 0 ? {} : _props$style,
    isSprite = props.isSprite;
  var pixiText = new text.Text(text$1, style);
  if (isSprite) {
    pixiText.updateText();
    return new sprite.Sprite(pixiText.texture);
  }
  return pixiText;
};
var Text$2 = Text$1;
...
var TilingSprite$1 = function TilingSprite(root, props) {
  ...
  var ts = new spriteTiling.TilingSprite(texture, width, height);
...
var SimpleMesh$1 = function SimpleMesh(root, props) {
  ...
  var vertices = props.vertices,
    ...
    drawMode = _props$drawMode === void 0 ? constants$1.DRAW_MODES.TRIANGLES : _props$drawMode;
  var simpleMesh = new meshExtras.SimpleMesh(texture, vertices, uvs, indices, drawMode);
...
var SimpleRope$1 = function SimpleRope(root, props) {
  ...
  var rope = new meshExtras.SimpleRope(texture, points);
...
function unmountComponent(container) {
  invariant(display.Container.prototype.isPrototypeOf(container), 'Invalid argument `container`, expected instance of `PIXI.Container`.');
...
var Stage = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Stage, [{
    ...
    value: function componentDidMount() {
      ...
      this.app = new app.Application(_objectSpread$1(_objectSpread$1({
        width: width,
        height: height,
        view: this._canvas
      }, options), {}, {
...
function useApp() {
  ...
  invariant(app$1 instanceof app.Application, 'No Context found with `%s`. Make sure to wrap component with `%s`', 'PIXI.Application', 'AppProvider');
  return app$1;
}
  ...
  React.useEffect(function () {
    if (enabled) {
      var tick = function tick(delta) {
        return savedRef.current.apply(app$1.ticker, [delta, app$1.ticker]);
      };
      app$1.ticker.add(tick);
      return function () {
        if (app$1.ticker) {
          app$1.ticker.remove(tick);
        }
      };
    }
  }, [enabled]);

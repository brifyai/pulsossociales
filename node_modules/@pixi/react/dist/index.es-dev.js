...
var Graphics$1 = function Graphics(root, _ref) {
  ...
  invariant(!geometry || geometry instanceof Graphics$3, "Graphics geometry needs to be a `PIXI.Graphics`");
...
function unmountComponent(container) {
  invariant(Container$3.prototype.isPrototypeOf(container), 'Invalid argument `container`, expected instance of `PIXI.Container`.');
...
export { AnimatedSprite, AppConsumer, Context as AppContext, AppProvider, BitmapText, Container, Graphics, NineSlicePlane, ParticleContainer, PixiComponent, PixiFiber, SimpleMesh, SimpleRope, Sprite, Stage$1 as Stage, TYPES, Text, TilingSprite, applyDefaultProps, createRoot, eventHandlers, render, unmountComponentAtNode, useApp, useTick, withFilters, withPixiApp };
